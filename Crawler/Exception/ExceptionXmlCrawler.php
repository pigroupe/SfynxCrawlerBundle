 ...
 * @since      2015-02-16
 */
class ExceptionXmlCrawler extends \Exception
{
    /**
    ...
    /**
     * Returns the <xml No Validated> Exception.
     *
     * @param string $file
     * @return \Exception
     * @access public
     * @static
     */
    public static function xmlNoValidated($type, $errors)
    {
        return new static(sprintf('The Xml source of the %s widget doesn\'t validated !', $type), $errors);
    }
}
